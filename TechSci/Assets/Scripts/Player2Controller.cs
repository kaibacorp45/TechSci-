...
public class Player2Controller : MonoBehaviour
{
    ...
    */
    ...
    private void Movement(bool isGrounded)
    {
        ...
        float hDirection = Input.GetAxisRaw("Horizontal2");

        if (canClimb && Mathf.Abs(Input.GetAxisRaw("Vertical2")) > .1f)
        {
            state = State.climb;
        ...
        //Jumping
        if (Input.GetButtonDown("Jump2") && /*coll.IsTouchingLayers(ground)*/ isGrounded)
        {
            Jump();
        }
    }
